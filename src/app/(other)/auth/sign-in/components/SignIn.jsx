            ...
            <Card className="auth-card">
              <CardBody className="px-3 py-5">
                <div className="mx-auto mb-4 text-center auth-logo">
                  <a className="logo-dark" href="#" onClick={(e) => e.preventDefault()}>
                    <Image src={logoDark} height={32} alt="logo dark" />
                  </a>
                  <a className="logo-light" href="#" onClick={(e) => e.preventDefault()}>
                ...
                <div className="px-4">
                  <form className="authentication-form" onSubmit={login}>
                    ...
                    <div className="mb-1 text-center d-grid">
                      <button
                        disabled={loading}
                        style={{ backgroundColor: '#352a87', color: '#fff' }}
                        className="btn  btn-theme py-2 fw-medium"
                        type="submit">
                        Sign In
                      </button>
                    </div>
