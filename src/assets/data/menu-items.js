// Icon Mapping for Menu Labels
const ICON_MAP = {
  Dashboards: 'ri:dashboard-2-line',
  Configurations: 'ri:settings-3-line',
...
// Updated Menu Items with Dynamic Icons
export const MENU_ITEMS = [
  ...
  },
  {
    key: 'dashboards',
    label: 'Dashboards',
    icon: ICON_MAP['Dashboards'],
    url: '/dashboards/analytics',
  },
  {
    key: 'configuration',
    label: 'Configurations',
    icon: ICON_MAP['Configurations'],
    url: '/configuration',
  },
  {
    key: 'trades',
    label: 'Trades',
    icon: ICON_MAP['Trades'],
    url: '/trades',
  },
  {
    key: 'reviews',
    label: 'Valuation',
    icon: ICON_MAP['Valuation'],
    url: '/valuation',
  },
  {
    key: 'messages',
    ...
    children: [
      {
        ...
        icon: ICON_MAP['Chart of Accounts'],
        url: '/chartofaccounts',
        parentKey: 'customers',
      },
      {
